...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <select class="form-control" name="prov_cl" id="prov_cl">
        ...
        $.ajax({
           ...
           {       
                if(res)
                {
                    ...
                    $.each(res,function(key,value){
                        $("#kelurahan").append("<option value='"+value+"'>"+value+' ('+key+")</option>");
                    });
                }
           }
